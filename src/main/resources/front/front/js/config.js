...
var centerMenu = [
    ...
    ,{
        name: '项目报名',
        url: '../bisaixiangmuYuyue/list.html'
    }
    ,{
        name: '赛程安排',
        url: '../siachenganpai/list.html'
    }
    ,{
        name: '资讯收藏',
        url: '../zixunCollection/list.html'
    }
    ,{
        name: '资讯留言',
        url: '../zixunLiuyan/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '项目信息',
        url: './pages/bisaixiangmu/list.html'
    },
    {
        name: '论坛',
    ...
    {
        name: '运动会资讯',
        url: './pages/zixun/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/xiaoyunhuiguanli/admin/dist/index.html#/login";
