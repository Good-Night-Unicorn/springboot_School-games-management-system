    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.bisaixiangmuYuyueYesnoTypes" label="审核状态" prop="bisaixiangmuYuyueYesnoTypes">
                        <el-input v-model="ruleForm.bisaixiangmuYuyueYesnoValue" placeholder="审核状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.bisaixiangmuYuyueYesnoText" label="审核回复" prop="bisaixiangmuYuyueYesnoText">
                        <span v-html="ruleForm.bisaixiangmuYuyueYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    yonghuId: false,
                    bisaixiangmuYuyueYesnoTypes: false,
                    bisaixiangmuYuyueYesnoText: false,
                    insertTime: false,
                },
                ruleForm: {
                    bisaixiangmuId: '',
                    yonghuId: '',
                    bisaixiangmuYuyueYesnoTypes: '',
                    bisaixiangmuYuyueYesnoText: '',
                    insertTime: '',
                },
                bisaixiangmuYuyueYesnoTypesOptions : [],
                bisaixiangmuOptions : [],
                yonghuOptions : [],
                rules: {
                   bisaixiangmuId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=bisaixiangmu_yuyue_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.bisaixiangmuYuyueYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`bisaixiangmuYuyue/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.bisaixiangmuYuyueCrossAddOrUpdateFlag = false;
                                        this.parent.search();
