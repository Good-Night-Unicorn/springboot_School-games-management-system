    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="资讯类型" prop="indexName">
                        <el-input v-model="ruleForm.indexName"
                                  placeholder="资讯类型" clearable  :readonly="ro.indexName"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="资讯类型" prop="indexName">
                            <el-input v-model="ruleForm.indexName"
            ...
            onSubmit() {
                ...
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        ...
                        ruleForm["dicCode"]="zixun_types";
                        ruleForm["dicName"]="资讯类型";
                        this.$http({
