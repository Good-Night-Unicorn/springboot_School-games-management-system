               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="项目标题" prop="bisaixiangmuName">
                       <el-input v-model="ruleForm.bisaixiangmuName"
                                 placeholder="项目标题" clearable  :readonly="ro.bisaixiangmuName"></el-input>
                   </el-form-item>
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.bisaixiangmuPhoto" label="项目封面" prop="bisaixiangmuPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.bisaixiangmuPhoto?$base.url+ruleForm.bisaixiangmuPhoto:''"
                            @change="bisaixiangmuPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="工作时间" prop="bisaixiangmuShijian">
                       <el-input v-model="ruleForm.bisaixiangmuShijian"
                                 placeholder="工作时间" clearable  :readonly="ro.bisaixiangmuShijian"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="负责人" prop="bisaixiangmuFuzhenr">
                       <el-input v-model="ruleForm.bisaixiangmuFuzhenr"
                                 placeholder="负责人" clearable  :readonly="ro.bisaixiangmuFuzhenr"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="联系方式" prop="bisaixiangmuPhone">
                       <el-input v-model="ruleForm.bisaixiangmuPhone"
                                 placeholder="联系方式" clearable  :readonly="ro.bisaixiangmuPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="项目类型" prop="bisaixiangmuTypes">
                        <el-select v-model="ruleForm.bisaixiangmuTypes" :disabled="ro.bisaixiangmuTypes" placeholder="请选择项目类型">
                            <el-option
                                v-for="(item,index) in bisaixiangmuTypesOptions"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.bisaixiangmuContent"  label="项目详情" prop="bisaixiangmuContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.bisaixiangmuContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.bisaixiangmuContent" label="项目详情" prop="bisaixiangmuContent">
                            <span v-html="ruleForm.bisaixiangmuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                userId:"",//当前登录人的id
                ro:{
                    bisaixiangmuName: false,
                    bisaixiangmuPhoto: false,
                    bisaixiangmuShijian: false,
                    bisaixiangmuFuzhenr: false,
                    bisaixiangmuPhone: false,
                    bisaixiangmuTypes: false,
                    jieshuTime: false,
                    bisaixiangmuContent: false,
                    bisaixiangmuDelete: false,
                    insertTime: false,
                },
                ruleForm: {
                    bisaixiangmuName: '',
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=bisaixiangmu_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.bisaixiangmuTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.bisaixiangmuContent = _this.ruleForm.bisaixiangmuContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.bisaixiangmuContent = this.ruleForm.bisaixiangmuContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`bisaixiangmu/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.bisaixiangmuCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            bisaixiangmuPhotoUploadChange(fileUrls){
                this.ruleForm.bisaixiangmuPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
