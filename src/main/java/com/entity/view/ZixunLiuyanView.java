...
public class ZixunLiuyanView extends ZixunLiuyanEntity implements Serializable {
	...
	public ZixunLiuyanView() {

	}

	public ZixunLiuyanView(ZixunLiuyanEntity zixunLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, zixunLiuyanEntity);
