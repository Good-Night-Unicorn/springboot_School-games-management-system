...
public class BisaixiangmuYuyueView extends BisaixiangmuYuyueEntity implements Serializable {
	...
	*/
	...
	private String bisaixiangmuYuyueYesnoValue;
	...
	public BisaixiangmuYuyueView() {

	}

	public BisaixiangmuYuyueView(BisaixiangmuYuyueEntity bisaixiangmuYuyueEntity) {
		try {
			BeanUtils.copyProperties(this, bisaixiangmuYuyueEntity);
	...
	* 获取： 审核状态的值
	*/
	public String getBisaixiangmuYuyueYesnoValue() {
		return bisaixiangmuYuyueYesnoValue;
	}
	/**
	* 设置： 审核状态的值
	*/
	public void setBisaixiangmuYuyueYesnoValue(String bisaixiangmuYuyueYesnoValue) {
		this.bisaixiangmuYuyueYesnoValue = bisaixiangmuYuyueYesnoValue;
	}
	...
	public String toString() {
		return "BisaixiangmuYuyueView{" +
			", bisaixiangmuYuyueYesnoValue=" + bisaixiangmuYuyueYesnoValue +
